...
dlib_facelandmark = dlib.shape_predictor("C:\\Users\Acer\\Desktop\\geeks\\article 9\\drowsinessDetector-master\\shape_predictor_68_face_landmarks1.dat")  # PUT THE LOCATION OF .DAT FILE (FILE FOR PREDECTING THE LANDMARKS ON FACE )
...
while True:
    ...
    for face in faces:
        ...
        if Eye_Rat<0.25:    # THIS VALUE OF 0.25 (YOU CAN EVEN CHANGE IT) WILL DECIDE WHETHER THE PERSONS'S EYES ARE CLOSE OR NOT
